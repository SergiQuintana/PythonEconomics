...
url = r"https://www.carrefour.es/supermercado/leche-entera-carrefour-brik-1-l/R-521006992/p"
driver.get(url)
...
totalproducts =driver.find_elements(By.XPATH, '//div[@class="pagination__results"]') 

print(len(totalproducts))

for prod in totalproducts:
...
def find_total_pages(browser):
    total_products = browser.find_element(By.XPATH, '//span[@class="plp-food-view__header__total-count"]').text
